...
errorMassage = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/h3_Error Last Name is required'))

println(errorMassage)

if(!(errorMassage.equals('Error: Last Name is required'))) {
