...
errorMassage = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/h3_Error First Name is required'))

println(errorMassage)

if (!(errorMassage.equals('Error: First Name is required'))) {
