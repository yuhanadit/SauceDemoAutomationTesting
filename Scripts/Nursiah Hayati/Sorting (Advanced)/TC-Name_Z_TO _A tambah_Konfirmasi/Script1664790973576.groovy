...
List<WebElement> webItemList = WebUI.findWebElements(findTestObject('Object Repository/Page_Swag Labs/Page_Swag Labs/ITEM'),10)
...
Collections.sort(sortedList, Collections.reverseOrder()) //Descending
