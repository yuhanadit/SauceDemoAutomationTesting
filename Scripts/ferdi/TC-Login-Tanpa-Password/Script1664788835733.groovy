...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Password is required'))

errorMessage = WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/h3_Epic sadface Password is required'))
